!function (a, b) {
    a.SCS = {version: "1.0.0"}, SCS.defaults = {
        ...
        c += '<div class="cascade_scroll_selects ' + a.skinCss + '" id="cascade_scroll_selects"><div class="scs_container"><div class="scs_cover"></div><div class="scs_dialog"><div class="scs_selects">', d.forEach(function (a) {
            c += '<div class="scs_selects_group"><div class="scs_selects_group_view"><div class="scs_items" data-height="240" id="' + a.id + '"></div></div></div>'
        }), c += '</div><div class="scs_btns"><div class="scs_btn scs_btn_ok">确定</div><div class="scs_btn scs_btn_cancel">取消</div></div></div></div></div>', b("#cascade_scroll_selects").remove(), b("body").append(c);
        ...
        }, a = b.extend({}, g, a), h = b(a.el), i = h.get(0), j = a.dataArr, k = a.startIndex, l = this, m = !1, n = !1, o = 0, p = 0, q = 0, r = q, s = 0, t = 0, u = (new Date).getTime(), v = 0, w = 0, x = !0;
        try {
            ontouchstart
        } catch (y) {
            x = !1

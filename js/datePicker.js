        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_cancel" style="font-family: 黑体">取消</div>' +
                    '<div class="date_btn lcalendar_finish" style="font-family: 黑体">确定</div>' +
                    '</div>' +
                    ...
                    '<div class="date_grid">' +
                    '<div style="display: none">年</div>' +
                    '</div>' +
                    '</div>' +
                    '<div>' +
                    '<div class="gear date_mm" data-datetype="date_mm"></div>' +
                    '<div class="date_grid">' +
                    '<div style="display: none">月</div>' +
                    '</div>' +
                    '</div>' +
                    '<div>' +
                    '<div class="gear date_dd" data-datetype="date_dd"></div>' +
                    '<div class="date_grid">' +
                    '<div style="display: none">日</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
